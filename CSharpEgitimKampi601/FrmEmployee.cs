...
namespace CSharpEgitimKampi601
{
    public partial class FrmEmployee : Form
    {
        ...
        string connectionstring = "Server=localhost;post=5432;Database=CustomerDb;user Id=postgress;password=1234";
        ...
        void DepartmentList()
        {
            ...
            cmbEmployeeDepartment.DisplayMember = "DepartmentName"; //Kullanıcıya gözükecek kısım
            cmbEmployeeDepartment.ValueMember = "DepartmentId"; //Arka planda çalışacak kısım
